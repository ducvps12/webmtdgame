...
<head>
    ...
    <title>Ðua Top N?p | Chú Bé R?ng Online</title>
    <meta name="description" content="B?ng x?p h?ng dua top n?p Chú Bé R?ng Online — ai là ngu?i ?ng h? d? án nhi?u nh?t?" />
...
<body>
    ...
    <main class="ranking-page">
        <h1>Ðua Top N?p</h1>
        <p class="subtitle">Vinh danh nh?ng ngu?i ?ng h? d? án — s? ti?n c? th? du?c ?n</p>

        <div class="rank-tabs">
            <a href="/bang-xep-hang" class="rank-tab">S?c M?nh</a>
            <a href="/top-nap" class="rank-tab active">Ðua Top N?p</a>
        ...
        <div class="rank-list">
            ...
            <div style="text-align: center; padding: 60px; color: var(--text-secondary);">Chua có d? li?u x?p h?ng.</div>
            <?php endif; ?>
        </div>

        <p class="update-time">C?p nh?t lúc: <?php echo date('H:i d/m/Y'); ?></p>
    </main>
