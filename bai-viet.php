...
<head>
    ...
    <title><?php echo $post_detail ? htmlspecialchars($post_detail['tieude']) : 'Bài vi?t không t?n t?i'; ?> - Di?n Ðàn</title>
    ...
    <nav class="apple-nav">
        <div class="nav-left">
            ...
            <ul class="nav-links">
                ...
                <li><a href="/forum" class="active">Di?n Ðàn</a></li>
                <li><a href="https://zalo.me/g/iktqgz458" target="_blank">C?ng Ð?ng</a></li>
            </ul>
        </div>
        <div class="nav-right">
    ...
    <div class="post-container">
        ...
        <?php if ($post_detail): ?>
            ...
            <div class="apple-post-card">
                <div class="post-header">
                    ...
                    <div class="post-body">
                        <div class="post-meta">
                            <span>Ðang lúc <?php echo htmlspecialchars($post_detail['created_at']); ?></span>
                        </div>
            ...
            <!-- Comments Section -->
            <div class="apple-post-card">
                <h3 style="margin-top:0; font-size:18px; margin-bottom:20px;">Bình lu?n</h3>
                ...
                <?php if ($_is_logged_in): ?>
                    ...
                    <form method="POST" action="bai-viet.php?id=<?php echo htmlspecialchars($post_id); ?>" style="margin-bottom: 30px;">
                        ...
                        <div style="display:flex; justify-content:space-between; align-items:center;">
                            ...
                            <button type="submit" name="submit_comment" class="btn-pill btn-black">G?i bình lu?n</button>
                        </div>
                    </form>
                    <?php else: ?>
                    <div style="background: rgba(239,68,68,0.05); padding: 16px 20px; border-radius: 12px; text-align: center; margin-bottom: 30px; border: 1px solid rgba(239,68,68,0.15);">
                        ...
                        <br><a href="/nap-atm" style="color: #0071e3; font-weight: 600; text-decoration: none; font-size: 13px; margin-top: 6px; display: inline-block;">N?p ngay d? m? khóa ?</a>
                        <?php endif; ?>
                    </div>
                    <?php endif; ?>
                <?php else: ?>
                    <div style="background: rgba(0,113,227,0.05); padding: 20px; border-radius: 12px; text-align: center; margin-bottom: 30px;">
                        B?n c?n <a href="/login" style="color: #0071e3; font-weight: 600; text-decoration: none;">Ðang nh?p</a> d? tham gia bình lu?n.
                    </div>
                <?php endif; ?>
                ...
                <div class="comments-list">
                                    ...
                                    <div style="display: flex; justify-content: space-between; align-items: center;">
                                        ...
                                        <div style="font-size: 11px; color: var(--text-secondary);">
                                            ...
                                            <?php if ($logged_in_username === $comment['nguoidung'] || $is_admin): ?>
                                                <a href="bai-viet.php?id=<?php echo htmlspecialchars($post_id); ?>&delete_comment_id=<?php echo htmlspecialchars($comment['id']); ?>" onclick="return confirm('Xác nh?n xoá bình lu?n?');" style="color: #ff3b30; margin-left: 10px; text-decoration: none;">Xoá</a>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                    ...
                    <?php else: ?>
                        <div style="text-align: center; color: var(--text-secondary); padding: 20px 0;">
                            Chua có bình lu?n nào. Hãy là ngu?i d?u tiên!
                        </div>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <?php else: ?>
            <div class="apple-post-card" style="text-align: center; padding: 50px 20px;">
                ...
                <p style="color: var(--text-secondary);">Bài vi?t không t?n t?i ho?c dã b? qu?n tr? viên xoá.</p>
                <a href="/forum" class="btn-pill btn-black" style="margin-top: 20px;">Tr? l?i Di?n Ðàn</a>
            </div>
        <?php endif; ?>
    </div>
