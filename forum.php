...
<head>
    ...
    <title>Trang Ch? - Chú Bé R?ng Onlines - Ng?c R?ng Online</title>
    <meta name="keywords" content="Chú Bé R?ng Online,ngoc rong mobile, game ngoc rong, game 7 vien ngoc rong, game bay vien ngoc rong" />
    <meta name="description" content="Website chính th?c c?a Chú Bé R?ng Online – Game Bay Vien Ng?c R?ng Mobile nh?p vai tr?c tuy?n trên máy tính và di?n tho?i v? Game 7 Viên Ng?c R?ng h?p d?n nh?t hi?n nay!" />
                                                ...
                                                $(document).ready(function() {
                                                    ...
                                                    $("form[name='loginform'], form[name='registerform']").submit(function(event) {
                                                        ...
                                                        if (now - lastPostTime < 10000) {
                                                            ...
                                                            $("#comment_error").css("color", "red").text("B?n ch? có th? post m?i 10 giây. Vui lòng ch? " + secondsLeft + " giây.");
                                                            return;
                                                        }
                                                        ...
                                                        $.post("/Api/Auth", formData)
                                                            ...
                                                            .fail(function(jqXHR) {
                                                                var errorMessage = (jqXHR.responseJSON && jqXHR.responseJSON.message) || "Vui lòng th? l?i trong ít phút n?a.";
